...
Piccola applicazione per scrivere le attività giornaliere da 
...
2. Installa le dipendenze con `npm i` (ricordati di avere una versione di node che va dalla 15 alla 17
3. Avvia l'applicazione scrivendo `npm run start`
